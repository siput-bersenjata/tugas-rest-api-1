const ApiKey = "0b569c47c6dc4f4b9a27d5e790ae900f";
...
const infoEndPoin = `${baseUrl}competitions/${leagueId}/teams`;
        ...
        .then(resJson => {
            ...
            resJson.teams.forEach(team => {
                ...
                <li class="collection-item avatar">
                    ...
                    <a href="#detail" class="secondary-content"><i class="material-icons">info</i></a>
                </li>
                `
            });
        ...
        .then(resJson => {
            ...
            resJson.teams.forEach(team => {
                ...
                <li class="collection-item avatar">
                    <img src="${team.crestUrl}" alt="" class="circle">
                    <span class="title">${team.name}</span>
                    <p>Sebutan: ${team.shortName} <br>
                       Lokasi: ${team.venue}<br>
                       Warna club: ${team.venue}<br>
                       Negara: ${team.venue}<br>
                    </p>
